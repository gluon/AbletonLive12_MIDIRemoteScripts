...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/_UserScript/DeviceComponent.py
...
class DeviceComponent(DeviceComponentBase):
    ...
    def _current_bank_details(self):
        ...
        if banks:
            ...
            if not (self._bank_index is not None):
                ...
                if multiple_banks:
                    if index < self._number_of_parameter_banks() - 1:
