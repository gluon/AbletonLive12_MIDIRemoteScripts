...
EXPOSED_TYPE_PROPERTIES = {(Live.Application.Application): (
 ...
 (Live.MeldDevice.MeldDevice): (tuple(_DEVICE_BASE_PROPS + [
                                MFLProperty("selected_engine"),
                                MFLProperty("unison_voices"),
 ...
 (Live.RoarDevice.RoarDevice): (tuple(_DEVICE_BASE_PROPS + [
                                MFLProperty("routing_mode_index"),
                                MFLProperty("routing_mode_list"),
                                MFLProperty("env_listen")])), 
