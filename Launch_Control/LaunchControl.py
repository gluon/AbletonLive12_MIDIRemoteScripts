...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/Launch_Control/LaunchControl.py
...
def make_all_encoders(name_prefix="", make_encoder=make_launch_control_encoder):
    return (
     [make_encoder(41 + index, name_prefix + "_Bottom_Encoder_" + str(index)) for index in range(8)],
     [make_encoder(21 + index, name_prefix + "_Top_Encoder_" + str(index)) for index in range(8)])
...
class LaunchControl(ControlSurface):
    ...
    def _init_mixer(self):
        ...
        modes_layer = Layer(pan_volume_button=(make_button(114, "Pan_Volume_Mode_Button")),
        ...
        self._mixer_track_nav_layer = Layer(track_bank_left_button=(make_button(116, "Mixer_Track_Left_Button")),
        ...
        for index in range(8):
            ...
            mute_button = make_button((pad_identifiers[index]),
              ("Track_Mute_Button_" + str(index)), is_pad=True)
    ...
    def _init_session(self):
        ...
        self._session_layer = Layer(track_bank_left_button=(make_button(116, "Track_Bank_Left_Button")),
          track_bank_right_button=(make_button(117, "Track_Bank_Right_Button")),
          select_prev_button=(make_button(114, "Scene_Bank_Up_Button")),
          select_next_button=(make_button(115, "Scene_Bank_Down_Button")),
          clip_launch_buttons=ButtonMatrixElement(rows=[clip_launch_buttons]))
    ...
    def _init_device(self):
        ...
        self._device = DeviceComponent(device_bank_registry=(self._device_bank_registry),
          name="Device",
          device_selection_follows_track_selection=True)
        self._device.set_enabled(False)
        self._device.layer = Layer(parameter_controls=ButtonMatrixElement(rows=[parameter_controls]),
        ...
        self._device_navigation.layer = Layer(next_device_button=(make_button(115, "Next_Device_Button")),
        ...
        self._view_control.layer = Layer(next_track_button=(make_button(117, "Device_Next_Track_Button")),
    ...
    def _init_modes(self):
        ...
        self._modes.layer = Layer(mixer_button=(ButtonSysexControl(Sysex.MIXER_MODE)),
