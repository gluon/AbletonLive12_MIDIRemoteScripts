...
class Axiom_AIR_25_49_61(ControlSurface):
    ...
    def _setup_controls(self):
        ...
        self._fader_group_midi_button.add_value_listener((self._midi_button_value),
          identify_sender=True)
        self._fader_group_mix_button = create_configurable_button(58, "Fader_Group_Mix_Button", 0, 1)
        self._fader_group_mix_button.add_value_listener((self._hyper_button_value),
          identify_sender=True)
        self._fader_group_fx_button = create_configurable_button(59, "Fader_Group_Inst_FX_Button", 0, -1)
        self._fader_group_fx_button.add_value_listener((self._hyper_button_value),
          identify_sender=True)
        self._encoders = []
        for index in range(8):
        ...
        self._encoder_group_midi_button.add_value_listener((self._midi_button_value),
          identify_sender=True)
        self._encoder_group_mix_button = create_configurable_button(25, "Encoder_Group_Mix_Button", 0, 72)
        self._encoder_group_mix_button.add_value_listener((self._hyper_button_value),
          identify_sender=True)
        self._encoder_group_fx_button = create_configurable_button(26, "Encoder_Group_Inst_FX_Button", 0, 72)
        self._encoder_group_fx_button.add_value_listener((self._hyper_button_value),
          identify_sender=True)
    ...
    def _setup_drum_pads(self):
        ...
        self._drum_group_hyper_button.add_value_listener((self._hyper_button_value),
          identify_sender=True)
    ...
    def _midi_button_value(self, value, sender):
        if value > 0:
            if sender is self._drum_group_midi_button:
                ...
                if sender is self._fader_group_midi_button:
                    if self._has_faders:
    ...
    def _hyper_button_value(self, value, sender):
        if value > 0:
            if sender is self._drum_group_hyper_button:
                ...
                if sender is self._fader_group_fx_button or sender is self._fader_group_mix_button:
