...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/Axiom_AIR_25_49_61/EncoderModeSelector.py
...
class EncoderModeSelector(ModeSelectorComponent):
    ...
    def _mode_value(self, value, sender):
        if self.is_enabled() and value != 0 or sender.is_momentary() or self._modes_buttons.index(sender) == 0:
