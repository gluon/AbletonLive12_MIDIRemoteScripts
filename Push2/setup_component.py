...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/Push2/setup_component.py
...
class SetupComponent(ModesComponent):
    ...
    def __init__(self, settings=None, pad_curve_sender=None, firmware_switcher=None, *a, **k):
        ...
        self._general = GeneralSettingsComponent(parent=self,
          settings=(settings.general),
          hardware_settings=(settings.hardware),
          is_enabled=False)
        self._info = InfoComponent(parent=self,
          firmware_switcher=firmware_switcher,
          is_enabled=False)
        self._pad_settings = PadSettingsComponent(parent=self,
          pad_settings=(settings.pad_settings),
          is_enabled=False)
        self._display_debug = DisplayDebugSettingsComponent(parent=self,
          settings=(settings.display_debug),
          is_enabled=False)
