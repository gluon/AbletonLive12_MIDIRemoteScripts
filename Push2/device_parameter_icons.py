...
MELD_OSCILLATOR_TYPES = ('meld_osc_basic_shapes', 'meld_osc_dual_basic_shapes', 'meld_osc_noisy_shapes',
                         'meld_osc_square_sync', 'meld_osc_square_5th', 'meld_osc_sub',
                         'meld_osc_swarm_sine', 'meld_osc_swarm_triangle', 'meld_osc_swarm_saw',
                         'meld_osc_swarm_square', 'meld_osc_harmonic_fm', 'meld_osc_fold_fm',
                         'meld_osc_squelch', 'meld_osc_simple_fm', 'meld_osc_chip',
                         'meld_osc_shepards_pi', 'meld_osc_tarp', 'meld_osc_extratone',
                         'meld_osc_noise_loop', 'meld_osc_filtered_noise', 'meld_osc_bitgrunge',
                         'meld_osc_crackle', 'meld_osc_rain', 'meld_osc_bubbles')
...
DEVICE_PARAMETER_IMAGES = {'Drift':{
 ...
 'InstrumentMeld':{'MeldVoice_EngineA_Oscillator_OscillatorType':MELD_OSCILLATOR_TYPES, 
 ...
 'MidiNoteLength':{'Trigger Source':ACTIVATE, 
  'Sync On':ACTIVATE}, 
