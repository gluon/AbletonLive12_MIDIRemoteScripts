...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/Push2/custom_bank_definitions.py
...
def _meld_drop_filter_section(x):
    return x.replace("A Filter ", "").replace("B Filter ", "")


def _meld_drop_lfo1_section(x):
    return x.replace("A LFO 1 ", "").replace("B LFO 1 ", "")


def _meld_drop_lfo1_fx1_section(x):
    return x.replace("A LFO 1 FX 1 ", "").replace("B LFO 1 FX 1 ", "")


def _meld_drop_lfo1_fx2_section(x):
    return x.replace("A LFO 1 FX 2 ", "").replace("B LFO 1 FX 2 ", "")
...
BANK_DEFINITIONS = {'AudioEffectGroupDevice':RACK_BANKS, 
 ...
 'InstrumentMeld':IndexedDict((
  (
   BANK_MAIN_KEY,
   {BANK_PARAMETERS_KEY: (
                          use("MeldVoice_EngineA_Oscillator_OscillatorType").with_name("Osc A Type"),
                          use("MeldVoice_EngineA_Oscillator_Macro1").with_name_transformer(_meld_drop_oscillator_section),
                          use("MeldVoice_EngineA_Oscillator_Macro2").with_name_transformer(_meld_drop_oscillator_section),
                          use("MeldVoice_EngineA_Filter_Frequency").with_name("Flt A Freq"),
                          use("MeldVoice_EngineB_Oscillator_OscillatorType").with_name("Osc B Type"),
                          use("MeldVoice_EngineB_Oscillator_Macro1").with_name_transformer(_meld_drop_oscillator_section),
                          use("MeldVoice_EngineB_Oscillator_Macro2").with_name_transformer(_meld_drop_oscillator_section),
                          use("MeldVoice_EngineB_Filter_Frequency").with_name("Flt B Freq")), 
    
    OPTIONS_KEY: ('Osc A', '', '', 'Osc B', '', '', '')}),
  (
   "Osc/Mix",
   {BANK_PARAMETERS_KEY: (
                          use("MeldVoice_EngineA_Oscillator_OscillatorType").with_name("Osc Type").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Oscillator_OscillatorType").with_name("Osc Type"),
                          use("MeldVoice_EngineA_Oscillator_Pitch_Transpose").with_name("Transpose").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Oscillator_Pitch_Transpose").with_name("Transpose"),
                          use("MeldVoice_EngineA_Oscillator_Pitch_Detune").with_name("Detune").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Oscillator_Pitch_Detune").with_name("Detune"),
                          use("MeldVoice_EngineA_Oscillator_Macro1").with_name_transformer(_meld_drop_oscillator_section).if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Oscillator_Macro1").with_name_transformer(_meld_drop_oscillator_section),
                          use("MeldVoice_EngineA_Oscillator_Macro2").with_name_transformer(_meld_drop_oscillator_section).if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Oscillator_Macro2").with_name_transformer(_meld_drop_oscillator_section),
                          use("MeldVoice_EngineA_ToneFilter").with_name("Tone").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_ToneFilter").with_name("Tone"),
                          use("MeldVoice_EngineA_Pan").with_name("Pan").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Pan").with_name("Pan"),
                          use("MeldVoice_EngineA_Volume").if_parameter("Selected Engine").with_name("Volume").has_value("A").else_use("MeldVoice_EngineB_Volume").with_name("Volume")), 
    
    OPTIONS_KEY: (
                  use("Osc A").if_parameter("Selected Engine").has_value("A").else_use("Osc B"),
                  "",
                  "",
                  "",
                  "",
  ...
  (
   "Envelopes",
   {BANK_PARAMETERS_KEY: (
                          use("Selected Env").with_name("Envelope"),
                          use("Envelope View").with_name("Env View"),
                          use("MeldVoice_EngineA_AmpEnvelope_Times_Attack").with_name("Attack").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Amp").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineA_FilterEnvelope_Times_Attack").with_name("Attack").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Mod").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineB_AmpEnvelope_Times_Attack").with_name("Attack").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Amp").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineA_FilterEnvelope_Times_Attack").with_name("Attack").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Mod").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineA_AmpEnvelope_Slopes_Attack").with_name("A Slope").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_AmpEnvelope_Slopes_Attack").with_name("A Slope"),
                          use("MeldVoice_EngineA_AmpEnvelope_Times_Decay").with_name("Decay").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Amp").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineA_FilterEnvelope_Times_Decay").with_name("Decay").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Mod").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineB_AmpEnvelope_Times_Decay").with_name("Decay").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Amp").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineA_FilterEnvelope_Times_Decay").with_name("Decay").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Mod").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineA_AmpEnvelope_Slopes_Decay").with_name("D Slope").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_AmpEnvelope_Slopes_Decay").with_name("D Slope"),
                          use("MeldVoice_EngineA_AmpEnvelope_Sustain").with_name("Sustain").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Amp").else_use("MeldVoice_EngineA_FilterEnvelope_Values_Sustain").with_name("Sustain").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Mod").else_use("MeldVoice_EngineB_AmpEnvelope_Sustain").with_name("Sustain").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Amp").else_use("MeldVoice_EngineB_FilterEnvelope_Values_Sustain").with_name("Sustain").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Mod"),
                          use("MeldVoice_EngineA_AmpEnvelope_Times_Release").with_name("Release").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Amp").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineA_FilterEnvelope_Times_Release").with_name("Release").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Mod").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineB_AmpEnvelope_Times_Release").with_name("Release").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Amp").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineB_FilterEnvelope_Times_Release").with_name("Release").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Mod").and_parameter("Envelope View").has_value("Time").else_use("MeldVoice_EngineA_AmpEnvelope_Slopes_Release").with_name("R Slope").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Amp").else_use("MeldVoice_EngineB_AmpEnvelope_Slopes_Release").with_name("R Slope").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Amp").else_use("MeldVoice_EngineA_FilterEnvelope_Slopes_Release").with_name("R Slope").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Mod").else_use("MeldVoice_EngineB_FilterEnvelope_Slopes_Release").with_name("R Slope"),
                          use("MeldVoice_EngineBDelay").with_name("Delay").if_parameter("Selected Engine").has_value("B").else_use("").with_name(""),
                          use("MeldVoice_EngineA_AmpEnvelope_LoopMode").with_name("Loop Mode").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Amp").else_use("MeldVoice_EngineA_FilterEnvelope_LoopMode").with_name("Loop Mode").if_parameter("Selected Engine").has_value("A").and_parameter("Selected Env").has_value("Mod").else_use("MeldVoice_EngineB_AmpEnvelope_LoopMode").with_name("Loop Mode").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Amp").else_use("MeldVoice_EngineB_FilterEnvelope_LoopMode").with_name("Loop Mode").if_parameter("Selected Engine").has_value("B").and_parameter("Selected Env").has_value("Mod")), 
    
    OPTIONS_KEY: ('', '', 'Link Envelopes', '', '', '', 'Selected Engine')}),
  (
   "Filters",
   {BANK_PARAMETERS_KEY: (
                          use("MeldVoice_EngineA_Filter_FilterType").with_name("Type").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Filter_FilterType").with_name("Type"),
                          use("MeldVoice_EngineA_Filter_Frequency").with_name("Frequency").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Filter_Frequency").with_name("Frequency"),
                          use("MeldVoice_EngineA_Filter_Macro1").with_name_transformer(_meld_drop_filter_section).if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Filter_Macro1").with_name_transformer(_meld_drop_filter_section),
                          use("MeldVoice_EngineA_Filter_Macro2").with_name_transformer(_meld_drop_filter_section).if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Filter_Macro2").with_name_transformer(_meld_drop_filter_section),
                          "",
                          "",
                          use("MeldVoice_EngineA_ToneFilter").with_name("Tone").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_ToneFilter").with_name("Tone"),
                          use("MeldVoice_EngineA_Volume").with_name("Volume").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Volume").with_name("Volume")), 
    
    OPTIONS_KEY: (
                  use("Filter A").if_parameter("Selected Engine").has_value("A").else_use("Filter B"),
                  "",
                  "",
                  "",
                  "",
  ...
  (
   "LFO 1",
   {BANK_PARAMETERS_KEY: (
                          use("MeldVoice_EngineA_Lfo1_GeneratorType").with_name("LFO 1 Type").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_GeneratorType").with_name("LFO 1 Type"),
                          use("MeldVoice_EngineA_Lfo1_SyncedRate").with_name("Rate").if_parameter("MeldVoice_EngineA_Lfo1_Sync").has_value("Tempo").and_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_SyncedRate").with_name("Rate").if_parameter("MeldVoice_EngineB_Lfo1_Sync").has_value("Tempo").and_parameter("Selected Engine").has_value("B").else_use("MeldVoice_EngineA_Lfo1_Rate").with_name("Rate").if_parameter("MeldVoice_EngineA_Lfo1_Sync").has_value("Free").and_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_Rate").with_name("Rate").if_parameter("MeldVoice_EngineB_Lfo1_Sync").has_value("Free").and_parameter("Selected Engine").has_value("B"),
                          use("MeldVoice_EngineA_Lfo1_PhaseOffset").with_name("Offset").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_PhaseOffset").with_name("Offset"),
                          use("MeldVoice_EngineA_Lfo1_GeneratorMacro1").with_name_transformer(_meld_drop_lfo1_section).if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_GeneratorMacro1").with_name_transformer(_meld_drop_lfo1_section),
                          use("MeldVoice_EngineA_Lfo1_GeneratorMacro2").with_name_transformer(_meld_drop_lfo1_section).if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_GeneratorMacro2").with_name_transformer(_meld_drop_lfo1_section),
                          use("MeldVoice_EngineA_Lfo1_Transformer1Type").with_name("Effect 1 Type").if_parameter("LFO1 Effect").has_value("Effect 1").and_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_Transformer1Type").with_name("Effect 1 Type").if_parameter("LFO1 Effect").has_value("Effect 1").and_parameter("Selected Engine").has_value("B").else_use("MeldVoice_EngineA_Lfo1_Transformer2Type").with_name("Effect 2 Type").if_parameter("LFO1 Effect").has_value("Effect 2").and_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_Transformer2Type").with_name("Effect 2 Type").if_parameter("LFO1 Effect").has_value("Effect 2").and_parameter("Selected Engine").has_value("B"),
                          use("MeldVoice_EngineA_Lfo1_Transformer1Macro").with_name_transformer(_meld_drop_lfo1_fx1_section).if_parameter("LFO1 Effect").has_value("Effect 1").and_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_Transformer1Macro").with_name_transformer(_meld_drop_lfo1_fx1_section).if_parameter("LFO1 Effect").has_value("Effect 1").and_parameter("Selected Engine").has_value("B").else_use("MeldVoice_EngineA_Lfo1_Transformer2Macro").with_name_transformer(_meld_drop_lfo1_fx2_section).if_parameter("LFO1 Effect").has_value("Effect 2").and_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo1_Transformer2Macro").with_name_transformer(_meld_drop_lfo1_fx2_section).if_parameter("LFO1 Effect").has_value("Effect 2").and_parameter("Selected Engine").has_value("B").else_use("MeldVoice_EngineB_Lfo1_Transformer2Macro").with_name_transformer(_meld_drop_lfo1_fx2_section),
                          use("")), 
    
    OPTIONS_KEY: (
                  use("LFO 1 A Sync").with_name("Sync").if_parameter("Selected Engine").has_value("A").else_use("LFO 1 B Sync"),
                  use("LFO 1 A Retrigger").if_parameter("Selected Engine").has_value("A").else_use("LFO 1 B Retrigger"),
                  "",
                  "",
                  "LFO1 Effect",
                  "",
  ...
  (
   "LFO 2",
   {BANK_PARAMETERS_KEY: (
                          use("MeldVoice_EngineA_Lfo2_Waveform").with_name("Waveform").if_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo2_Waveform").with_name("Waveform"),
                          use("MeldVoice_EngineA_Lfo2_SyncedRate").with_name("Rate").if_parameter("MeldVoice_EngineA_Lfo2_Sync").has_value("Tempo").and_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo2_SyncedRate").with_name("Rate").if_parameter("MeldVoice_EngineB_Lfo2_Sync").has_value("Tempo").and_parameter("Selected Engine").has_value("B").else_use("MeldVoice_EngineA_Lfo2_Rate").with_name("Rate").if_parameter("MeldVoice_EngineA_Lfo2_Sync").has_value("Free").and_parameter("Selected Engine").has_value("A").else_use("MeldVoice_EngineB_Lfo2_Rate").with_name("Rate").if_parameter("MeldVoice_EngineB_Lfo2_Sync").has_value("Free").and_parameter("Selected Engine").has_value("B"),
                          "",
                          "",
                          "",
                          "",
    ...
    OPTIONS_KEY: (
                  use("LFO 2 A Sync").if_parameter("Selected Engine").has_value("A").else_use("LFO 2 B Sync"),
                  "",
                  "",
                  "",
                  "",
  ...
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          "Stack Voices",
                          use("MeldVoice_VoiceSpreadAmount").with_name("Spread Amt"),
                          "Mono Poly",
                          "Poly Voices",
                          use("MeldVoice_EngineA_GlideTime").with_name("Glide A Time"),
                          use("MeldVoice_EngineB_GlideTime").with_name("Glide B Time"),
                          use("MeldVoice_Drive").with_name("Drive"),
                          "Volume"), 
    
    OPTIONS_KEY: ('', '', '', 'Glide A', 'Glide B', 'Limiter', '')}))), 
 ...
 'OriginalSimpler':IndexedDict((
  ...
  (
   "Pan & PB",
   {BANK_PARAMETERS_KEY: ('Pan', 'Spread', 'Pan < Rnd', 'Pan < LFO', 'PB Range', 'Note PB', '', ''), 
 ...
 'MidiCcControl':IndexedDict((
  (
   "1-8",
   {BANK_PARAMETERS_KEY: ('Mod Wheel', 'Pitch Bend', 'Pressure', 'Custom A', 'Custom B', 'Custom C', 'Custom D',
 'Custom E'), 
    
    OPTIONS_KEY: ('Resend', '', 'Button', '', '', '', '')}),
  (
   "9-16",
   {BANK_PARAMETERS_KEY: ('Custom F', 'Custom G', 'Custom H', 'Custom I', 'Custom J', 'Custom K', 'Custom L',
 'Custom M'), 
    
    OPTIONS_KEY: ('Resend', '', '', '', '', '', '')}),
  (
   "1-8 Map",
   {BANK_PARAMETERS_KEY: ('', '', '', 'Custom Button Target', 'Custom Target 1', 'Custom Target 2', 'Custom Target 3',
 'Custom Target 4'), 
    
    OPTIONS_KEY: ('Resend', '', '', '', '', '', '')}),
  (
   "8-16 Map",
   {BANK_PARAMETERS_KEY: ('Custom Target 5', 'Custom Target 6', 'Custom Target 7', 'Custom Target 8', 'Custom Target 9',
 'Custom Target 10', 'Custom Target 11', 'Custom Target 12'), 
 ...
 'MidiNoteLength':IndexedDict((
  (
   BANK_MAIN_KEY,
   {BANK_PARAMETERS_KEY: (
                          use("Trigger Source").with_name("Trigger Src"),
                          use("Sync On").if_parameter("Latch").has_value("Off"),
                          use("Synced Length").if_parameter("Sync On").has_value("On").and_parameter("Latch").has_value("Off").else_use("Time Length").if_parameter("Latch").has_value("Off"),
                          use("Gate").if_parameter("Latch").has_value("Off"),
                          use("Release Velocity").with_name("Rel Vel").if_parameter("Latch").has_value("Off"),
                          use("Decay Time").if_parameter("Latch").has_value("Off"),
                          use("Decay Key Scale").if_parameter("Latch").has_value("Off"),
                          "Latch")}),)), 
 ...
 'MidiRandom':IndexedDict((
  (
   BANK_MAIN_KEY,
   {BANK_PARAMETERS_KEY: ('Chance', 'Choices', 'Mode', 'Interval', 'Sign', '', '', '')}),)), 
 ...
 'Roar':IndexedDict((
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          "Drive",
                          use("Shaper 1 Type").if_parameter("Stage Select").has_value("1").else_use("Shaper 2 Type").if_parameter("Stage Select").has_value("2").else_use("Shaper 3 Type"),
                          use("Shaper 1 Amt").if_parameter("Stage Select").has_value("1").else_use("Shaper 2 Amt").if_parameter("Stage Select").has_value("2").else_use("Shaper 3 Amt"),
                          use("Shaper 1 Bias").if_parameter("Stage Select").has_value("1").else_use("Shaper 2 Bias").if_parameter("Stage Select").has_value("2").else_use("Shaper 3 Bias"),
                          "Flt 1 Freq",
                          "Comp Amt",
                          "Output",
                          "Dry/Wet"), 
  ...
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          ...
                          "Tone Freq",
                          "Routing",
                          use("Blend").if_parameter("Routing").has_value("Serial").else_use("Blend").if_parameter("Routing").has_value("Parallel").else_use("Blend").if_parameter("Routing").has_value("Mid Side").else_use("Blend").if_parameter("Routing").has_value("Feedback").else_use("Low Mid X-Over").if_parameter("Routing").has_value("Multi Band").else_use(""),
                          use("Mid High X-Over").if_parameter("Routing").has_value("Multi Band").else_use("Fb Amt").if_parameter("Routing").has_value("Feedback").else_use(""),
                          "Output",
                          "Dry/Wet"), 
    ...
    OPTIONS_KEY: (
                  ...
                  "",
                  "",
                  use("Fb Inv").if_parameter("Routing").has_value("Feedback").else_use(""),
                  "",
                  "")}),
  (
   "Shaper",
   {BANK_PARAMETERS_KEY: (
                          ...
                          use("Shaper 1 Amt").if_parameter("Stage Select").has_value("1").else_use("Shaper 2 Amt").if_parameter("Stage Select").has_value("2").else_use("Shaper 3 Amt"),
                          use("Shaper 1 Bias").if_parameter("Stage Select").has_value("1").else_use("Shaper 2 Bias").if_parameter("Stage Select").has_value("2").else_use("Shaper 3 Bias"),
                          use("Shaper 1 Level").if_parameter("Stage Select").has_value("1").else_use("Shaper 2 Level").if_parameter("Stage Select").has_value("2").else_use("Shaper 3 Level"),
                          use("Flt 1 Type").if_parameter("Stage Select").has_value("1").else_use("Flt 2 Type").if_parameter("Stage Select").has_value("2").else_use("Flt 3 Type"),
                          use("Flt 1 Freq").if_parameter("Stage Select").has_value("1").else_use("Flt 2 Freq").if_parameter("Stage Select").has_value("2").else_use("Flt 3 Freq"),
                          use("Flt 1 Morph").if_parameter("Stage Select").has_value("1").and_parameter("Flt 1 Type").has_value("Morph").else_use("Flt 1 Peak").if_parameter("Stage Select").has_value("1").and_parameter("Flt 1 Type").has_value("Peak").else_use("Flt 1 Res").if_parameter("Stage Select").has_value("1").else_use("Flt 2 Morph").if_parameter("Stage Select").has_value("2").and_parameter("Flt 2 Type").has_value("Morph").else_use("Flt 2 Peak").if_parameter("Stage Select").has_value("2").and_parameter("Flt 2 Type").has_value("Peak").else_use("Flt 2 Res").if_parameter("Stage Select").has_value("2").else_use("Flt 3 Morph").if_parameter("Stage Select").has_value("3").and_parameter("Flt 3 Type").has_value("Morph").else_use("Flt 3 Peak").if_parameter("Stage Select").has_value("3").and_parameter("Flt 3 Type").has_value("Peak").else_use("Flt 3 Res").if_parameter("Stage Select").has_value("3")), 
    
    OPTIONS_KEY: (
                  use("Stage 1").if_parameter("Stage Select").has_value("1").else_use("Stage 2").if_parameter("Stage Select").has_value("2").else_use("Stage 3"),
                  use("Shaper 1").if_parameter("Stage Select").has_value("1").else_use("Shaper 2").if_parameter("Stage Select").has_value("2").else_use("Shaper 3"),
                  "",
                  "",
                  use("Filter 1").if_parameter("Stage Select").has_value("1").else_use("Filter 2").if_parameter("Stage Select").has_value("2").else_use("Filter 3"),
                  use("Filter 1 Pre").if_parameter("Stage Select").has_value("1").else_use("Filter 2 Pre").if_parameter("Stage Select").has_value("2").else_use("Filter 3 Pre"),
                  "")}),
  (
   "Mod Sources",
   {BANK_PARAMETERS_KEY: (
                          "Source",
                          use("LFO 1 Wave").if_parameter("Source").has_value("LFO 1").else_use("LFO 2 Wave").if_parameter("Source").has_value("LFO 2").else_use("Env Attack").if_parameter("Source").has_value("Env").else_use("Noise Type"),
                          use("LFO 1 Rate Mode").if_parameter("Source").has_value("LFO 1").else_use("LFO 2 Rate Mode").if_parameter("Source").has_value("LFO 2").else_use("Env Release").if_parameter("Source").has_value("Env").else_use("Noise Rate Mode"),
                          use("LFO 1 Rate").if_parameter("Source").has_value("LFO 1").and_parameter("LFO 1 Rate Mode").has_value("Free").else_use("LFO 1 Synced Rate").if_parameter("Source").has_value("LFO 1").and_parameter("LFO 1 Rate Mode").has_value("Synced").else_use("LFO 1 Synced Rate").if_parameter("Source").has_value("LFO 1").and_parameter("LFO 1 Rate Mode").has_value("Triplet").else_use("LFO 1 Synced Rate").if_parameter("Source").has_value("LFO 1").and_parameter("LFO 1 Rate Mode").has_value("Dotted").else_use("LFO 1 16th").if_parameter("Source").has_value("LFO 1").and_parameter("LFO 1 Rate Mode").has_value("Sixteenth").else_use("LFO 2 Rate").if_parameter("Source").has_value("LFO 2").and_parameter("LFO 2 Rate Mode").has_value("Free").else_use("LFO 2 Synced Rate").if_parameter("Source").has_value("LFO 2").and_parameter("LFO 2 Rate Mode").has_value("Synced").else_use("LFO 2 Synced Rate").if_parameter("Source").has_value("LFO 2").and_parameter("LFO 2 Rate Mode").has_value("Triplet").else_use("LFO 2 Synced Rate").if_parameter("Source").has_value("LFO 2").and_parameter("LFO 2 Rate Mode").has_value("Dotted").else_use("LFO 2 16th").if_parameter("Source").has_value("LFO 2").and_parameter("LFO 2 Rate Mode").has_value("Sixteenth").else_use("Env Thresh").if_parameter("Source").has_value("Env").else_use("Noise Rate").if_parameter("Source").has_value("Noise").and_parameter("Noise Rate Mode").has_value("Free").else_use("Noise Synced Rate").if_parameter("Source").has_value("Noise").and_parameter("Noise Rate Mode").has_value("Synced").else_use("Noise Synced Rate").if_parameter("Source").has_value("Noise").and_parameter("Noise Rate Mode").has_value("Triplet").else_use("Noise Synced Rate").if_parameter("Source").has_value("Noise").and_parameter("Noise Rate Mode").has_value("Dotted").else_use("Noise 16th").if_parameter("Source").has_value("Noise").and_parameter("Noise Rate Mode").has_value("Sixteenth"),
                          use("LFO 1 Morph").if_parameter("Source").has_value("LFO 1").else_use("LFO 2 Morph").if_parameter("Source").has_value("LFO 2").else_use("Env Gain").if_parameter("Source").has_value("Env").else_use("Noise Smooth"),
                          use("LFO 1 Smooth").if_parameter("Source").has_value("LFO 1").else_use("LFO 2 Smooth").if_parameter("Source").has_value("LFO 2").else_use("Env Freq").if_parameter("Source").has_value("Env").else_use(""),
                          use("Env Width").if_parameter("Source").has_value("Env"),
                          ""), 
  ...
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          ...
                          "Fb Amt",
                          "Fb Time Mode",
                          use("Fb Time").if_parameter("Fb Time Mode").has_value("Time").else_use("Fb Synced").if_parameter("Fb Time Mode").has_value("Synced").or_parameter("Fb Time Mode").has_value("Triplet").or_parameter("Fb Time Mode").has_value("Dotted").else_use("Fb Note"),
                          "Fb Freq",
                          "Fb Width",
                          "Comp Amt",
                          "Dry/Wet"), 
    
    OPTIONS_KEY: ('Fb Inv', 'Fb Gate', '', '', '', 'Comp Hp', '')}),
  (
   "Global",
   {BANK_PARAMETERS_KEY: ('Drive', 'Routing', 'Blend', 'Global Mod Amt', 'Fb Amt', 'Comp Amt', 'Output', 'Dry/Wet'), 
 ...
 'Resonator':IndexedDict((
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          "I Note",
                          use("Filter Type").with_name("Flt Type"),
                          use("Frequency").with_name("Flt Freq"),
                          "Decay",
                          "Color",
                          "Width",
                          "Global Gain",
    ...
    OPTIONS_KEY: ('Filter', '', 'Constant', 'Mode', '', '', '')}),
  (
   "Modes",
   {BANK_PARAMETERS_KEY: (
                          "Select",
                          use("I Note").if_parameter("Select").has_value("Pitch").else_use("I Tune").if_parameter("Select").has_value("Fine Tune").else_use("I Gain"),
                          use("II Pitch").if_parameter("Select").has_value("Pitch").else_use("II Tune").if_parameter("Select").has_value("Fine Tune").else_use("II Gain"),
                          use("III Pitch").if_parameter("Select").has_value("Pitch").else_use("III Tune").if_parameter("Select").has_value("Fine Tune").else_use("III Gain"),
                          use("IV Pitch").if_parameter("Select").has_value("Pitch").else_use("IV Tune").if_parameter("Select").has_value("Fine Tune").else_use("IV Gain"),
                          use("V Pitch").if_parameter("Select").has_value("Pitch").else_use("V Tune").if_parameter("Select").has_value("Fine Tune").else_use("V Gain"),
                          "Global Gain",
                          "Dry/Wet"), 
    
    OPTIONS_KEY: ('I', 'II', 'III', 'IV', 'V', '', '')}))), 
 'Reverb':IndexedDict((
  (
   BANK_MAIN_KEY,
   {BANK_PARAMETERS_KEY: (
