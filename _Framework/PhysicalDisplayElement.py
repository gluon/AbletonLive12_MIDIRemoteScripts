...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/_Framework/PhysicalDisplayElement.py
# Compiled at: 2024-03-09 01:30:22
# Size of source mod 2**32: 13797 bytes
...
class DisplayElement(ControlElement):
    ...
    def display_string(self):
        return "".join(map(str, self._logical_segments))
    ...
    def set_num_segments(self, num_segments):
        ...
        if not in_range(num_segments, 1, width) or width % num_segments != 0:
            raise_(DisplaySegmentationError, "Can not split display of size %d into %d segments" % (
