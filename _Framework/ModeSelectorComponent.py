...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/_Framework/ModeSelectorComponent.py
...
class ModeSelectorComponent(ControlSurfaceComponent):
    ...
    def _toggle_value(self, value):
        if not (value != 0 or self._mode_toggle.is_momentary()):
