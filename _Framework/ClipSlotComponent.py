...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/_Framework/ClipSlotComponent.py
# Compiled at: 2024-03-09 01:30:22
# Size of source mod 2**32: 10398 bytes
        ...
        if not self.has_clip():
            ...
            if song.select_on_launch:
                if self._clip_slot.is_triggered:
                    if self._has_fired_slot:
                        if self._clip_slot.will_record_on_start:
                            if self._clip_slot != view.highlighted_clip_slot:
