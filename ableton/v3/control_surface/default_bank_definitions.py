...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/ableton/v3/control_surface/default_bank_definitions.py
# Compiled at: 2024-03-09 01:30:22
# Size of source mod 2**32: 132452 bytes
...
BANK_DEFINITIONS["MidiNoteLength"] = IndexedDict((
 (
  BANK_MAIN_KEY,
  {BANK_PARAMETERS_KEY: (
                         use("Trigger Source").with_name("Trigger Src").if_parameter("Latch").has_value("Off"),
