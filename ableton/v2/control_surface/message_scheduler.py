...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/ableton/v2/control_surface/message_scheduler.py
# Compiled at: 2024-03-09 01:30:22
# Size of source mod 2**32: 9549 bytes
...
class MessageScheduler(object):
    ...
    def _process_request(self, request):
        if request.action == "send" and not self._state == "idle":
