...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/ableton/v2/control_surface/default_bank_definitions.py
 ...
 'MidiNoteLength':IndexedDict((
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          ...
                          use("Release Velocity").with_name("Rel Vel").if_parameter("Trigger Source").has_value("On").and_parameter("Latch").has_value("Off"),
                          use("Decay Time").if_parameter("Trigger Source").has_value("On").and_parameter("Latch").has_value("Off"),
                          use("Decay Key Scale").if_parameter("Trigger Source").has_value("On").and_parameter("Latch").has_value("Off"),
                          "Latch")}),)), 
