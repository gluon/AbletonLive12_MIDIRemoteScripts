...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/ableton/v2/control_surface/device_parameter_bank.py
    ...
    def _collect_parameters(self):
        ...
        def _collect_parameter(slot_definition):
            ...
            return parameter and (
             parameter,
             display_name_transformer and display_name_transformer(parameter.name)) or (None,
                                                                                        None)
