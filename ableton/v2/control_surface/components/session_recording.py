...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/ableton/v2/control_surface/components/session_recording.py
...
class SessionRecordingComponent(Component):
    automation_button = ToggleButtonControl(toggled_color="Automation.On",
    ...
    def __init__(self, view_controller=None, *a, **k):
        ...
        song = self.song
        self._SessionRecordingComponent__on_tracks_changed_in_live.subject = song
        self._SessionRecordingComponent__on_is_playing_changed_in_live.subject = song
        ...
        self._SessionRecordingComponent__on_session_automation_record_changed.subject = song
        self._SessionRecordingComponent__on_session_automation_record_changed()
        self._SessionRecordingComponent__on_re_enable_automation_enabled_changed.subject = song
        self._SessionRecordingComponent__on_re_enable_automation_enabled_changed()

    def set_scene_list_new_button(self, button):
        self._scene_list_new_button = button
        self._SessionRecordingComponent__on_scene_list_new_button_value.subject = button
        self._update_scene_list_new_button()

    def set_new_button(self, button):
        self._new_button = button
        self._SessionRecordingComponent__on_new_button_value.subject = button
        self._update_new_button()

    def set_new_scene_button(self, button):
        self._new_scene_button = button
        self._SessionRecordingComponent__on_new_scene_button_value.subject = button
