...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/ableton/v2/control_surface/components/device_navigation.py
...
class FlattenedDeviceChain(ItemProvider):
    ...
    def _update_listeners(self):
        ...
        racks = [rack for rack, nesting_level in self._devices if getattr(rack, "can_have_chains", False)]
