...
class SimplerDeviceDecorator(EventObject, LiveObjectDecorator):
    ...
    def setup_parameters(self):
        ...
        self.pitch_bend_range_param = IntegerParameter(name="PB Range",
          parent=self,
        ...
        self.note_pitch_bend_range_param = IntegerParameter(name="Note PB",
          parent=self,
          integer_value_host=(self._live_object),
          integer_value_property_name="note_pitch_bend_range",
          min_value=0,
          max_value=48,
          show_as_quantized=False,
          display_value_conversion=(lambda x: unicode(x) + " st"))
...
self._live_object.sample.gain_display_string() # Avoid dead code: ""))
        ...
        self._additional_parameters.extend([
         ...
         self.voices_param,
         self.pitch_bend_range_param,
         self.note_pitch_bend_range_param])
