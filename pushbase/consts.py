...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/pushbase/consts.py
# Compiled at: 2024-03-09 01:30:22
# Size of source mod 2**32: 11867 bytes
from __future__ import absolute_import, print_function, unicode_literals
from builtins import object
import sys, Live
from ableton.v2.control_surface import DEFAULT_PRIORITY
DISPLAY_LENGTH = 72
SIDE_BUTTON_COLORS = dict(color="DefaultButton.On",
...
class MessageBoxText(object):
    ...
    COPIED_PAGE = "     Page copied.           Press destination page to paste"
    PASTED_PAGE = "     Page duplicated."
    CANNOT_COPY_EMPTY_PAGE = "                  Cannot copy empty page"
    CANNOT_PASTE_TO_SOURCE_PAGE = "                    Cannot paste to source page"
    CANNOT_PASTE_FROM_STEP_TO_PAGE = "                    Cannot paste from step to page"
    CANNOT_COPY_EMPTY_STEP = "                  Cannot copy empty step"
    CANNOT_PASTE_TO_SOURCE_STEP = "                    Cannot paste to source step"
    PAGE_CLEARED = "                    Page cleared"
    CANNOT_CLEAR_EMPTY_PAGE = "                    Cannot clear empty page"
    CANNOT_PASTE_FROM_PAGE_TO_STEP = "                    Cannot paste from page to step"
    ...
    ALTERNATE_LOOP_SELECTOR = "          Loop Selector"
    ALTERNATE_16_VELOCITIES = "          16 Velocities"
    ALTERNATE_56_PADS = "          Loop Selector"
    ALTERNATE_PLAY_LOOP = "          Loop Selector"
    ALTERNATE_SEQUENCE_LOOP = "          Loop Selector"
    LAYOUT_MELODIC_PLAYING = "        Melodic:  64 Notes"
    LAYOUT_MELODIC_SEQUENCER = "        Melodic:  Sequencer"
    LAYOUT_MELODIC_32_PADS = "        Melodic:  Sequencer  +  32  Notes"
    LAYOUT_MELODIC_32_PADS_LOOP_SELECTOR = "        Loop Selector"
...
if not _test_mode:
    try:
        ...
        for attr in _proto_list:
            try:
                _local_consts = __import__("local_consts", globals(), locals(), [attr])
