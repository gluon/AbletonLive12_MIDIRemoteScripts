...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/LV2_LX2_LC2_LD2/Devices.py
# Compiled at: 2024-03-09 01:30:22
# Size of source mod 2**32: 22548 bytes
...
NTL_BANK1 = ('Trigger Source', 'Time Length', 'Synced Length', 'Gate', 'Decay Time',
             'Release Velocity', 'Decay Key Scale', '')
NTL_BANKS = NTL_BANK1
NTL_BOBS = NTL_BANK1
PIT_BANK1 = ('Pitch', 'Range', 'Lowest', '', '', '', '', '')
PIT_BANKS = PIT_BANK1
PIT_BOBS = PIT_BANK1
RND_BANK1 = ('Chance', 'Choices', 'Interval', 'Sign', '', '', '', '')
RND_BANKS = RND_BANK1
RND_BOBS = RND_BANK1
