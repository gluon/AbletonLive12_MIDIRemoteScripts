...
# Embedded file name: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/RemoteSL_Classic/MixerController.py
# Compiled at: 2024-03-09 01:30:22
# Size of source mod 2**32: 24280 bytes
...
class MixerController(RemoteSLComponent):
    ...
    def receive_midi_ccParse error at or near `COME_FROM' instruction at offset 180_7
    ...
    def __handle_page_up_down_ccsParse error at or near `COME_FROM' instruction at offset 188_7

    def __handle_select_button_ccsParse error at or near `COME_FROM' instruction at offset 84_5

    def __handle_transport_ccsParse error at or near `COME_FROM' instruction at offset 254_10
    ...
    def __on_record_mode_changed(self):
        if not self._MixerController__transport_locked:
            record_cc = self.support_mkII() or TS_RECORD_CC
            if self.support_mkII():
                record_cc = 53
        else:
